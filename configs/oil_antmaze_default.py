...
def get_parser():
    ...
    parser.add_argument('--mismatch', default=False, type=boolean) # flag for using pointmass demostration
    parser.add_argument('--example', default=False, type=boolean) # flag for using success examples
    parser.add_argument('--reverse', default=False, type=boolean) 
